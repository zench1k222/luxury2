...
public class BooleanSettingRenderer extends SettingRenderer {
    ...
    public float render(DrawContext context, Setting setting, float x, float y, float width, int mouseX, int mouseY, float scrollOffset) {
        ...
        Color toggleBgColor = value ? new Color(45, 125, 255) : new Color(100, 100, 110);
        RenderUtil.drawRoundedRect(context.getMatrices(), toggleX, toggleY, toggleWidth, toggleHeight,
                new Vector4f(7f, 7f, 7f, 7f), toggleBgColor.getRGB());
