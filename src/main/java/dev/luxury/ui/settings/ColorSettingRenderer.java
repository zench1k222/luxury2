...
public class ColorSettingRenderer extends SettingRenderer {
    ...
    public float render(DrawContext context, Setting setting, float x, float y, float width, int mouseX, int mouseY, float scrollOffset) {
        ...
        RenderUtil.drawRoundedRect(context.getMatrices(), colorBoxX, colorBoxY, colorBoxSize, colorBoxSize,
                new Vector4f(3f, 3f, 3f, 3f), color);

        RenderUtil.drawBorder(context.getMatrices(), colorBoxX, colorBoxY, colorBoxSize, colorBoxSize,
                new Vector4f(3f, 3f, 3f, 3f), new Color(60, 60, 70).getRGB(), 1f, 1, 1, false);
