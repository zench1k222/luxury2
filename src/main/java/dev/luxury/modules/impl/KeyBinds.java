...
public class KeyBinds {
    ...
    String[] icons = {"A", "B", "C", "D", "E", "F", "G", "H", "I","J","K","L","M","N","O","P","Q","R"};
    ...
    public void render(EventRender2D e) {
        ...
        float width = 97.5f;
        float startX = screenWidth - width - 10;
        int startY = 50;
        int titleHeight = 14;
        ...
        for (Module module : boundModules) {
            ...
            sfpro2.drawFontLeft(e.getDrawContext().getMatrices(), keyName, startX + width - keyWidth - PADDING, currentY - 1, colorfonts2);
