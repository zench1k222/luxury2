...
public class Simulation {
    ...
    public Simulation(PlayerEntity player,
    ...
    public static Simulation simulateLocalPlayer(int ticks) {
        var simulatedPlayer = Simulation.fromClientPlayer(
    ...
    public static Simulation simulateOtherPlayer(PlayerEntity player, int ticks) {
        var simulatedPlayer = Simulation.fromOtherPlayer(player, SimulatedPlayerInput.guessInput(player));
    ...
    public static Simulation fromClientPlayer(SimulatedPlayerInput input) {
    ...
    public static Simulation fromOtherPlayer(PlayerEntity player, SimulatedPlayerInput input) {
        return new Simulation(
                player,
                input,
                player.getPos(),
    ...
    public static class SimulatedPlayerInput extends Input {
        ...
        public static SimulatedPlayerInput guessInput(PlayerEntity entity) {
            ...
            if (horizontalVelocity > 0.05 * 0.05) {
                double velocityAngle = Move.getDegreesRelativeToView(velocity, entity.getYaw());
                double wrappedAngle = MathHelper.wrapDegrees(velocityAngle);
                input = Move.getDirectionalInputForDegrees(input, wrappedAngle);
            }
            return new SimulatedPlayerInput(input);
        }
    }
