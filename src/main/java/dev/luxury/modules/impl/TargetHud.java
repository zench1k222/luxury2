    ...
    public void render(EventRender2D e) {
        ...
        if (target != null) {
            ...
            if (currentBarWidth > 0) {
                ...
                FontDraw.Montserrat_Medium.drawGradientString(e.getDrawContext().getMatrices(),name,startX + 37, startY + 5,0xFFFFFF00, 0xFF808080,true,3000,0);
                FontDraw.Montserrat_Medium.drawGradientString(e.getDrawContext().getMatrices(),hp,startX + 37, startY + 15,0xFFFFFF00, 0xFF808080,true,3000,0);
