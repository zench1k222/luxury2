    ...
    public void direction(EventDirection direction) {
        ...
        try {
            ...
            if (killAura != null) {
                ...
                isSpookytime = killAura.getRotationMode().is("Spookytime");
                isFuntime = killAura.getRotationMode().is("FunTime");
            }
        } catch (Exception e) {
        }

        if (isSlothAI || isSpookytime || isFuntime) {
